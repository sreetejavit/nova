...
class HPVSDriver(driver.ComputeDriver):
    """HPVS implementation of ComputeDriver."""
    capabilities = {
        "supports_pcpus": False,

        # Image type support flags
        # TODO docker image format
        "supports_image_type_aki": False,
        "supports_image_type_ami": False,
        "supports_image_type_ari": False,
        "supports_image_type_iso": False,
        "supports_image_type_qcow2": False,
        #https://wiki.openstack.org/wiki/Docker#Glance_configuration
    ...
    def _import_spawn_image(self, context, image_meta_id, image_os_version):
        ...
        image_path = os.path.join(os.path.normpath(CONF.hpvs.image_tmp_path),
                                  image_meta_id)
    ...
    def snapshot(self, context, instance, image_id, update_task_state):
        ...
        image_path = os.path.join(os.path.normpath(
                            CONF.hpvs.image_tmp_path), image_id)
        ...
        new_image_meta = {
            ...
            'properties': {
                 ...
                 'hypervisor_type': obj_fields.HVType.HPVS,
            },
            'disk_format': 'raw',
